...
exports.Calendar = function (p) {
    ...
    return (React.createElement("div", { className: "datepicker__calendar__container" },
        ...
        React.createElement("div", { "data-testid": "datepicker__calendar__body" }, viewModel.map(function (week, weekIndex) { return (React.createElement("div", { className: "datepicker__calendar__week", key: weekIndex, "data-testid": "datepicker__calendar__week" }, week.map(function (maybeDate, dayIndex) { return (React.createElement("div", { className: classnames_1.default('datepicker__calendar__day', {
                'datepicker__calendar__day--selected': isEqual(maybeDate, p.value),
                'datepicker__calendar__day--disabled': O.isNone(maybeDate),
            }), key: dayIndex, onClick: handleClick(maybeDate), "data-testid": "datepicker__calendar__day--" + formatDate(maybeDate) }, formatDate(maybeDate))); }))); }))));
};
